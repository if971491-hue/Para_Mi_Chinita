...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Con amor, Tu Negrito";
...
function showCountdown() {
  ...
  function update() {
    ...
    container.innerHTML =
      `Juntitos desde: <b>${days}</b> días<br>` +
      `Cumplimos 1 año en: <b>${eventDays}d ${eventHours}h ${eventMinutes}m ${eventSeconds}s</b>`;
